                    ...
                    <form action="{{ route('admin.open.ai.settings.update') }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="ol-form-control ol-select2" name="open_ai_model">
                                ...
                                <option value="gpt-4-turbo" @if (get_settings('open_ai_model') == 'gpt-4-turbo') selected @endif>gpt-4-turbo ({{ get_phrase('Required premium account') }})
                                </option>
                                <option value="gpt-4o" @if (get_settings('open_ai_model') == 'gpt-4o') selected @endif>gpt-4o ({{ get_phrase('Required premium account') }})
                                </option>
                            </select>
                        </div>
