                                ...
                                <div class="wrapper-image-preview  d-flex justify-content-center">
                                    <div class="box">
                                        <div class="upload-options">
                                            @php
                                                $banner_image_data = get_frontend_settings('banner_image');
                                                $banneractive = get_frontend_settings('home_page');
                                                $banner = null;

                                                if ($banner_image_data) {
                                                    $bannerData = json_decode($banner_image_data);
                                                    if ($bannerData !== null && is_object($bannerData) && $banneractive && property_exists($bannerData, $banneractive)) {
                                                        $banner = $bannerData->$banneractive;
                                                    } elseif (!$banneractive) {
                                ...
                                <div class="wrapper-image-preview  d-flex justify-content-center">
                                    <div class="box">
                                        <div class="upload-options">
                                            ...
                                            @endphp
                                            @if($light_logo)
                                                <img src="{{ asset($light_logo) }}" alt="" class="bg-dark radious-15px px-2 py-2">
                                            @endif
                            ...
                            <div class="form-group mb-2">
                                <div class="wrapper-image-preview  d-flex justify-content-center">
                                    <div class="box">
                                        <div class="upload-options">
                                            @php
                                                $dark_logo = get_frontend_settings('dark_logo');
                                            @endphp
                                            @if($dark_logo)
                                                <img src="{{ asset($dark_logo) }}" alt="">
                                            @endif
                            ...
                            <div class="form-group mb-2">
                                <div class="wrapper-image-preview d-flex justify-content-center">
                                    <div class="box">
                                        ...
                                        @endphp
                                        @if($favicon)
                                            <img width="100px" src="{{ asset($favicon) }}" alt="">
                                        @endif
                                        <div class="upload-options">
