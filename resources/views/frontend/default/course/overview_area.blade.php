<div class="ps-box p-0 shadow-none animate__animated animate__fadeIn">
    <h4 class="fw-900 text-dark mb-4 display-6">{{ get_phrase('Course Overview') }}</h4>
    <div class="description text-secondary fs-5 lh-lg mb-4" id="ellipsis-4">
    ...
    @if (isset($course_details->description))
        <a href="#" class="btn btn-link text-primary fw-bold text-decoration-none p-0 d-flex align-items-center gap-2 transition-all hover-gap-3" id="more_description">
