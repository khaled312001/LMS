                ...
                <div class="col-lg-12">
                    <nav aria-label="breadcrumb" class="mb-4">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ get_phrase('Terms and condition') }}</li>
                        </ol>
                    </nav>
                    <h1 class="display-3 fw-900 g-title mb-0">{{ get_phrase('Terms And Condition') }}</h1>
                </div>
            </div>
        </div>
    </section>
